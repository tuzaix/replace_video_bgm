...
def main() -> None:
    ...
    parser.add_argument("-m", "--model", dest="model", type=str, default="medium", choices=["tiny","base","small","medium","large-v3"], help="Whisper 模型大小（默认 medium）")
    ...
    try:
        ...
        try:
            ...
            pass
        out = gen.save_srt(args.video_path, args.output, translate=args.translate)
